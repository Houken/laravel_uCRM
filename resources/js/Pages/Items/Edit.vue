                            ...
                            <div class="container px-5 py-8 mx-auto">
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label class="leading-7 text-sm text-gray-600">状態</label>
                                                <input type="radio" id="is_selling_yes" name="is_selling" v-model="form.is_selling" value="1" class="ml-4">
                                                <label for="is_selling_yes" class="ml-2">販売中</label>
                                                <input type="radio" id="is_selling_no" name="is_selling" v-model="form.is_selling" value="0" class="ml-4">
                                                <label for="is_selling_no" class="ml-2">停止中</label>
